# system-audio-share-onlinux

Windows alternative: system-audio-share-onwindows

I needed a way to share my system audio in video calls so I developed an easy solution, and here it is.
Pipewire only
...
- Turn off the studio sound in google meet so the software works better for music;
