...
download_and_hash() {
    ...
    export OUTPUTS_TO_INPUTS_ADV_HASH="${file_hashes[outputs-to-inputs-adv.py]}"
    export AUDIO_MONITOR_HASH="${file_hashes[audio_monitor.py]}"
}
...
modules:
  ...
  - name: audioshare
    ...
    build-commands:
      ...
      - install -Dm755 outputs-to-inputs-adv.py /app/bin/outputs-to-inputs-adv.py
      - install -Dm755 audio_monitor.py /app/bin/audio_monitor.py
    ...
    sources:
      ...
      - type: file
        url: ${GITHUB_BASE_URL}/outputs-to-inputs-adv.py
        sha256: ${OUTPUTS_TO_INPUTS_ADV_HASH}
        dest-filename: outputs-to-inputs-adv.py

      - type: file
        url: ${GITHUB_BASE_URL}/audio_monitor.py
        sha256: ${AUDIO_MONITOR_HASH}
        dest-filename: audio_monitor.py    
